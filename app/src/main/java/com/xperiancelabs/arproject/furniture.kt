...
val customButtonColor1 = Color(0xFF1976D2) // Deep blue color
val customFabColor2 = Color(0xFFC2185B) // Pink color
val customShape3: Shape = RoundedCornerShape(16.dp)// Rounded corners
@Composable
fun  FurnitureARScreen1(navController: NavController) {
    val context = LocalContext.current
    var modelNode by remember { mutableStateOf<ArModelNode?>(null) }
    val modelFiles = listOf("furniture/furn1.glb", "furniture/furn2.glb","furniture/furn3.glb") // Add your model file names here
