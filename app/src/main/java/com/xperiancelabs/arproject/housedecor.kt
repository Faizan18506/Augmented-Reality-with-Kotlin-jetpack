...
val customButtonColor11 = Color(0xFF1976D2) // Deep blue color
val customFabColor22 = Color(0xFFC2185B) // Pink color
val customShape33: Shape = RoundedCornerShape(16.dp)// Rounded corners
@Composable
fun  HouseDecorARScreen1(navController: NavController) {
    val context = LocalContext.current
    var modelNode by remember { mutableStateOf<ArModelNode?>(null) }
    val modelFiles = listOf("model5/decor1.glb", "model5/decor2.glb","model5/decor3.glb", "model5/decor4.glb") // Add your model file names here
