...
//import io.github.sceneview.utilities.*



val customButtonColor = Color(0xFF1976D2) // Deep blue color
val customFabColor = Color(0xFFC2185B) // Pink color
val customShape: Shape = RoundedCornerShape(16.dp)// Rounded corners
@Composable
fun  OnboardingScreen(navController: NavController) {
    val context = LocalContext.current
    var modelNode by remember { mutableStateOf<ArModelNode?>(null) }
    val modelFiles = listOf("house/house1.glb", "house/house2.glb","house/house3.glb") // Add your model file names here
